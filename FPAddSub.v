...
//altfp_add_sub CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 add_sub clock dataa datab result
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPAddSub_altfp_add_sub_29k
	( 
	add_sub,
	clock,
	dataa,
...
endmodule //FPAddSub_altfp_add_sub_29k
//VALID FILE
...
module FPAddSub (
	...
	FPAddSub_altfp_add_sub_29k	FPAddSub_altfp_add_sub_29k_component (
				.add_sub (add_sub),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
