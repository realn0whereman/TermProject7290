...
module  FPFtoI_altbarrel_shift_rvf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FPFtoI_altbarrel_shift_rvf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPFtoI_altfp_convert_e1n
	( 
	clock,
	dataa,
	result) ;
	...
	FPFtoI_altbarrel_shift_rvf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //FPFtoI_altfp_convert_e1n
//VALID FILE
...
module FPFtoI (
	...
	FPFtoI_altfp_convert_e1n	FPFtoI_altfp_convert_e1n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL FPFtoI.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPFtoI.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPFtoI.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPFtoI_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPFtoI_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPFtoI.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPFtoI.cmp FALSE TRUE
